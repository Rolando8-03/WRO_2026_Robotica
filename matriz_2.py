...
def ejecutar_matriz_2(robot):
    ...
    robot.avanzar_cruzando_lineas(cruces_objetivo=2, velocidad=900, escape_inicial_cm=8, retraso_freno_ms=85, perfil="seguro")
    ...
    robot.avanzar_recto(distancia_cm=22.5, velocidad_max=400, perfil="seguro")
    ...
    robot.avanzar_recto(distancia_cm=17, velocidad_max=350, perfil="seguro")
