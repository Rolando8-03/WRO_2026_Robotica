...
robot.girar(angulo_deg=-76, potencia_max=100, perfil="encadenado") 
wait(80)
...
robot.avanzar_con_torque(
    distancia_cm=-18.1, 
    distancia_activacion_torque_cm=8.35, 
    torque_grados=170
)
