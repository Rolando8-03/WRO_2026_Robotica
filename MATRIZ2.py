...
def ejecutar_matriz_2(robot):
    ...
    robot.seguir_linea_extremo(sensor_color=robot.seguidor, velocidad_max=60, distancia_cm=11, lado="izquierda", tiempo_acomodo_ms=140, tiempo_aceleracion_ms=140, kp=1.25, kd=2.7, k_freno=0.16, correccion_max=100, objetivo_reflexion=27, captura_inicial=True, tiempo_captura_ms=280, potencia_captura=60, kp_captura=2.5, perfil_salida="encadenado")
    robot.esperar(200)
    ...
    robot.seguir_linea_extremo(sensor_color=robot.seguidor, velocidad_max=100, distancia_cm=12, lado="derecha", tiempo_acomodo_ms=140, tiempo_aceleracion_ms=140, kp=1.25, kd=2.7, k_freno=0.16, correccion_max=100, objetivo_reflexion=27, captura_inicial=True, tiempo_captura_ms=280, potencia_captura=60, kp_captura=2.5, perfil_salida="encadenado")
    robot.esperar(200)
    robot.girar(80, velocidad=650, velocidad_min=600, kp=5.0, tolerancia=0.5, perfil="encadenado")
    robot.seguir_linea_extremo(sensor_color=robot.seguidor, velocidad_max=80, distancia_cm=10, lado="derecha", tiempo_acomodo_ms=140, tiempo_aceleracion_ms=140, kp=1.25, kd=2.7, k_freno=0.16, correccion_max=100, objetivo_reflexion=27, captura_inicial=True, tiempo_captura_ms=280, potencia_captura=60, kp_captura=2.5, perfil_salida="encadenado")
    ...
    robot.seguir_linea_extremo(sensor_color=robot.seguidor, velocidad_max=100, distancia_cm=13, lado="derecha", tiempo_acomodo_ms=140, tiempo_aceleracion_ms=140, kp=1.25, kd=2.7, k_freno=0.16, correccion_max=100, objetivo_reflexion=27, captura_inicial=True, tiempo_captura_ms=280, potencia_captura=60, kp_captura=2.5, perfil_salida="encadenado")
    robot.mover_garra(500, -50, esperar=False, potencia_apriete=100)
    robot.mover_garra_delantera(600, -150)

    # Sigue la línea indefinidamente hasta detectar rojo o azul
    ...
    robot.esperar(400)
    robot.girar(-3, velocidad=650, velocidad_min=600, kp=5.0, tolerancia=0.5, perfil="encadenado")
    robot.mover_recto(distancia_cm=13.5, velocidad=650, perfil="encadenado")
    robot.mover_garra_delantera(400, 70)
    robot.mover_garra_rapida(potencia=10, grados=10, abrir=True)
    '''
