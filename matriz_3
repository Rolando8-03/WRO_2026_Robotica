...
def ejecutar_matriz_3(robot):
    ...
    robot.avanzar_recto(-17, velocidad_max=800)
    robot.girar(-90, 100)
    ...
    robot.avanzar_recto(distancia_cm=-14, velocidad_max=800)
    ...
    robot.mover_garra_delantera(400, 55.5)
...
#Tomar los siguientes seis bloques de la matriz==============================================================================
    ...
    robot.avanzar_recto(distancia_cm=-16, velocidad_max=800)
    ...
    robot.giro_derecha(-90, velocidad= 600)
...
#Seguir linea para ir por los blancos #======================================
    ...
    robot.giro_derecha(-100, velocidad= 600)
    ...
    robot.mover_garra_delantera(600, 98)
