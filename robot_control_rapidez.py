...
class Base:
    ...
    perfil="seguro"
        ...
        while True:
            ...
            velocidad_actual = abs(error) * kp

            velocidad_actual = self.limitar(
                velocidad_actual,
                velocidad_min,
                velocidad
            )
            ...
            if error > 0:
                pot_izq = velocidad_actual
                pot_der = -velocidad_actual
            else:
                pot_izq = -velocidad_actual
                pot_der = velocidad_actual
    ...
    def mover_garra(
        ...
        """
        Uso lógico:
        - grados positivo = abrir
        - grados negativo = cerrar

        apretar=True:
            Al cerrar, deja presión continua.

        apretar=False:
            Cierra solo los grados indicados.
        """
    ...
    abrir=True
        ...
        while abs(self.motor_garra.angle()) < grados:
            wait(1)
    ...
    def seguir_linea_extremo(
        ...
        while True:
            ...
            derivative = (
                (error - last_error) * 0.65
            ) + (
                last_derivative * 0.35
            )
...
# =========================
    # SEGUIDOR DE LÍNEA INDEFINIDO HASTA DETECTAR COLOR
    # =========================
