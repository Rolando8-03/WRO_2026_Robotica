...
class Base:
    ...
    def girar(
        ...
        # Preparación especial para que el giro salga sobre su propio eje.
        # Esto reemplaza la necesidad de poner wait(300) afuera.
        self.preparar_giro_eje(
            perfil=perfil,
            reset_gyro=True
        )
        ...
        # Salida del giro.
        # Sigue siendo corta, pero mata la inercia mejor que un stop directo.
    ...
    def preparar_giro_eje(
        self,
        perfil="encadenado",
        reset_gyro=True
    ):
        """
        Prepara el robot para girar sobre su propio eje.
        Evita usar waits grandes afuera del giro.
        """
